...
/// then passed into LittleStreakUp and the view hierarchy via environment. No global singleton.
///
...
enum AppDependencies {
    ...
    /// Set by AppDelegate in didFinishLaunching so LittleStreakUp can read it once to build the view model. Not a global getter.
    ...
    /// Called by AppDelegate after creating the container. Do not use from app code; only LittleStreakUp reads launchContainer.
